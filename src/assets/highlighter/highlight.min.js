/*!
  Highlight.js v11.11.1 (git: defe21ba15)
...
return n?Number(n):(e=>$.includes(e.toLowerCase()))(e)?0:1}const j={},P=e=>{
...
;const x=W(v);let k="",O=r||x;const M={},A=new p.__emitter(p);(()=>{const e=[]
...
;T=e.index+n}w(t.substring(T))}return A.finalize(),k=A.toHTML(),{language:e,
...
context:t.slice(T-100,T+100),mode:n.mode,resultSoFar:k},_emitter:A};if(s)return{
...
match:/&([a-zA-Z0-9]+|#[0-9]{1,7}|#[Xx][0-9a-fA-F]{1,6});/}]}},grmr_metal:e=>{
const n=e.regex,t=e.COMMENT("//","$",{contains:[{begin:/\\\n/}]
}),a="decltype\\(auto\\)",i="[a-zA-Z_]\\w*::",r="(?!struct)("+a+"|"+n.optional(i)+"[a-zA-Z_]\\w*"+n.optional("<[^<>]+>")+")",s={
className:"string",variants:[{begin:'(u8?|U|L)?"',end:'"',illegal:"\\n",
contains:[e.BACKSLASH_ESCAPE]},{
begin:"(u8?|U|L)?'(\\\\(x[0-9A-Fa-f]{2}|u[0-9A-Fa-f]{4,8}|[0-7]{3}|\\S)|.)",
end:"'",illegal:"."},e.END_SAME_AS_BEGIN({
begin:/(?:u8?|U|L)?R"([^()\\ ]{0,16})\(/,end:/\)([^()\\ ]{0,16})"/})]},o={
className:"number",variants:[{
begin:"[+-]?(?:(?:[0-9](?:'?[0-9])*\\.(?:[0-9](?:'?[0-9])*)?|\\.[0-9](?:'?[0-9])*)(?:[Ee][+-]?[0-9](?:'?[0-9])*)?|[0-9](?:'?[0-9])*[Ee][+-]?[0-9](?:'?[0-9])*|0[Xx](?:[0-9A-Fa-f](?:'?[0-9A-Fa-f])*(?:\\.(?:[0-9A-Fa-f](?:'?[0-9A-Fa-f])*)?)?|\\.[0-9A-Fa-f](?:'?[0-9A-Fa-f])*)[Pp][+-]?[0-9](?:'?[0-9])*)(?:[Hh]|[Ff]|)"
},{
begin:"[+-]?\\b(?:0[Bb][01](?:'?[01])*|0[Xx][0-9A-Fa-f](?:'?[0-9A-Fa-f])*|0(?:'?[0-7])*|[1-9](?:'?[0-9])*)(?:[Uu](?:LL?|ll?)|[Uu][Zz]?|(?:LL?|ll?)[Uu]?|[Zz][Uu]|)"
}],relevance:0},c={className:"meta",begin:/#\s*[a-z]+\b/,end:/$/,keywords:{
keyword:"if else elif endif define undef warning error line pragma ifdef ifndef include elseif"
},contains:[{begin:/\\\n/,relevance:0},e.inherit(s,{className:"string"}),{
className:"string",begin:/<.*?>/},t,e.C_BLOCK_COMMENT_MODE]
},l=["alignas","alignof","and","and_eq","asm","auto","bitand","bitor","bool","break","case","catch","char","char8_t","char16_t","char32_t","class","compl","concept","const","constant","consteval","constexpr","constinit","const_cast","continue","decltype","default","delete","device","do","double","dynamic_cast","else","enum","explicit","export","extern","false","float","for","friend","goto","if","inline","int","long","mutable","namespace","new","noexcept","not","not_eq","nullptr","operator","or","or_eq","private","protected","public","register","reinterpret_cast","requires","return","short","signed","sizeof","static","static_assert","static_cast","struct","switch","template","this","thread","throw","true","try","typedef","typeid","typename","union","unsigned","using","void","volatile","wchar_t","while","xor","xor_eq"],d=["abs","acos","acosh","asin","asinh","atan","atan2","atanh","ceil","clamp","cos","cosh","cross","degrees","distance","dot","exp","exp2","fabs","floor","fma","fmod","fract","frexp","inversesqrt","ldexp","length","log","log2","max","min","mix","modf","normalize","pow","radians","reflect","refract","round","rsqrt","saturate","sign","sin","sinh","smoothstep","sqrt","step","tan","tanh","trunc","faceforward","determinant","transpose","all","any","select","pack_float_to_snorm4x8","pack_float_to_unorm4x8","unpack_snorm4x8_to_float","unpack_unorm4x8_to_float","pack_float_to_snorm2x16","pack_float_to_unorm2x16","unpack_snorm2x16_to_float","unpack_unorm2x16_to_float","atomic_compare_exchange_weak_explicit","atomic_exchange_explicit","atomic_fetch_add_explicit","atomic_fetch_and_explicit","atomic_fetch_max_explicit","atomic_fetch_min_explicit","atomic_fetch_or_explicit","atomic_fetch_sub_explicit","atomic_fetch_xor_explicit","atomic_load_explicit","atomic_store_explicit","threadgroup_barrier","simdgroup_barrier","mem_flags","sample","read","write","gather","gather_compare","sample_compare"],g=["vertex","fragment","kernel","vertex_id","instance_id","base_vertex","base_instance","position","point_size","clip_distance","color","front_facing","sample_id","sample_mask","depth","stage_in","stage_out","buffer","texture","sampler","threadgroup"],u={
className:"type",begin:"\\b[a-z\\d_]*_t\\b"},b={className:"type-vector",
begin:"\\b(bool2|bool3|bool4|char2|char3|char4|uchar2|uchar3|uchar4|short2|short3|short4|ushort2|ushort3|ushort4|int2|int3|int4|uint2|uint3|uint4|long2|long3|long4|ulong2|ulong3|ulong4|half2|half3|half4|bfloat2|bfloat3|bfloat4|float2|float3|float4)\\b",
relevance:0},m={className:"type-matrix",
begin:"\\b(float2x2|float2x3|float2x4|float3x2|float3x3|float3x4|float4x2|float4x3|float4x4|half2x2|half2x3|half2x4|half3x2|half3x3|half3x4|half4x2|half4x3|half4x4)\\b",
relevance:0},p={className:"type-texture",
begin:"\\b(texture1d|texture1d_array|texture2d|texture2d_array|texture2d_ms|texture2d_ms_array|texture3d|texturecube|texturecube_array|texture_buffer|depth2d|depth2d_array|depth2d_ms|depth2d_ms_array|depthcube|depthcube_array|sampler)\\b",
relevance:0};n.optional(i),e.IDENT_RE
;const _=n.optional(i)+e.IDENT_RE+"\\s*\\(",h={keyword:l,
type:["bool","char","char8_t","char16_t","char32_t","double","float","int","long","short","void","wchar_t","unsigned","signed","const","static","uchar","ushort","uint","ulong","half","bfloat"].concat(["device","constant","thread","threadgroup","threadgroup_imageblock","atomic_int","atomic_uint","atomic_bool"]),
literal:["true","false","nullptr","NULL"],built_in:d.concat(g)},f={
className:"meta",begin:/\[\[/,end:/\]\]/,keywords:{keyword:g},
contains:[e.C_NUMBER_MODE,t,e.C_BLOCK_COMMENT_MODE]},E={
className:"function.dispatch",relevance:0,keywords:{_hint:d},
begin:n.concat(/\b/,`(?!${l.join("|")})`,e.IDENT_RE,n.lookahead(/(<[^<>]+>|)\s*\(/))
},y=[E,c,f,m,b,p,u,t,e.C_BLOCK_COMMENT_MODE,o,s],w={variants:[{begin:/=/,end:/;/
},{begin:/\(/,end:/\)/},{beginKeywords:"new throw return else",end:/;/}],
keywords:h,contains:y.concat([{begin:/\(/,end:/\)/,keywords:h,
contains:y.concat(["self"]),relevance:0}]),relevance:0},v={className:"function",
begin:"("+r+"[\\*&\\s]+)+"+_,returnBegin:!0,end:/[{;=]/,excludeEnd:!0,
keywords:h,illegal:/[^\w\s\*&:<>.]/,contains:[f,{begin:a,keywords:h,relevance:0
},{begin:_,returnBegin:!0,contains:[{className:"title.function",
begin:e.IDENT_RE,relevance:0}],relevance:0},{begin:/::/,relevance:0},{begin:/:/,
endsWithParent:!0,contains:[s,o]},{relevance:0,match:/,/},{className:"params",
begin:/\(/,end:/\)/,keywords:h,relevance:0,
contains:[f,t,e.C_BLOCK_COMMENT_MODE,s,o,m,b,p,u,{begin:/\(/,end:/\)/,
keywords:h,relevance:0,contains:["self",f,t,e.C_BLOCK_COMMENT_MODE,s,o,m,b,p,u]
}]},m,b,p,u,t,e.C_BLOCK_COMMENT_MODE,c]};return{name:"Metal",aliases:["metal"],
keywords:h,illegal:"</",classNameAliases:{"function.dispatch":"built_in"},
contains:[].concat(w,v,E,y,[c,f,{begin:e.IDENT_RE+"::",keywords:h},{
match:[/\b(?:enum(?:\s+(?:class|struct))?|class|struct|union)/,/\s+/,/\w+/],
className:{1:"keyword",3:"title.class"}}])}},grmr_objectivec:e=>{
...
;const N=[y,E,e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE,e.HASH_COMMENT_MODE,d,g,h],x={
...
contains:[x,e.HASH_COMMENT_MODE,e.COMMENT("//","$"),e.COMMENT("/\\*","\\*/",{
...
contains:["self",x,s,E,e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE,e.HASH_COMMENT_MODE,d,g]
...
contains:["self"]}),a=[e.C_LINE_COMMENT_MODE,t],i={match:[/\./,m(...ke,...Oe)],
className:{2:"keyword"}},r={match:b(/\./,m(...Ae)),relevance:0
},s=Ae.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:m(...Ae.filter((e=>"string"!=typeof e)).concat(Me).map(xe),...Oe)}]},c={
...
}),N=(e="")=>({begin:b(e,/"/),end:b(/"/,e),contains:[E(e),w(e)]}),x={
className:"string",
...
contains:[...k,{scope:"comment",begin:`#(?!.*${t})`,end:/$/}]}},A={
...
contains:[{begin:/\(/,end:/\)/,keywords:je,contains:[...p,f,x]}]}},{
...
relevance:0}]};for(const e of x.variants){
const n=e.contains.find((e=>"interpol"===e.label));n.keywords=c
;const t=[...l,...g,...p,f,x,...C];n.contains=[...t,{begin:/\(/,end:/\)/,
...
scope:{1:"keyword",3:"keyword"}},j,z,U,{beginKeywords:"import",end:/$/,
contains:[...a],relevance:0},A,...l,...g,...p,f,x,...C,...T,R,I]}},
grmr_typescript:e=>{
